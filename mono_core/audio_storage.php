...
class AudioStorage extends TableItem {
	// BD Table Settings
	public $_siteSettings;
	public $_bd_table_prefix_names;
	public $_bd_table_names = '_audio_storage';
	public $_fields_name = Array('id', 'file_link', 'order_by', 'is_active', 'date');
	...
	function CreateNew() {
		...
		$_link = $formsProcessing->FilesProcessing('file_storage/audio', 'file_link', '', 100);
		if($_link != ''){
